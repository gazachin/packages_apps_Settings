...
public final class Ranking {
    ...
    public static final int RANK_AICP_INTER_FACE = 6;
    public static final int RANK_AICP_STUFF = 7;
    public static final int RANK_AICP_SYSTEM = 8;
    public static final int RANK_AICP_TWEAKS = 9;
    ...
    public static final int RANK_HAND = 39;
    public static final int RANK_STORAGE = 40;
    public static final int RANK_POWER_USAGE = 41;
    public static final int RANK_USERS = 42;
    public static final int RANK_LOCATION = 43;
    public static final int RANK_SECURITY = 44;
    public static final int RANK_IME = 45;
    public static final int RANK_PRIVACY = 46;
    public static final int RANK_DATE_TIME = 47;
    public static final int RANK_ACCESSIBILITY = 48;
    ...
    static {
        ...
        // AICP Extras
        sRankMap.put(Interface.class.getName(), RANK_AICP_INTER_FACE);
        ...
        // AICP Extras
        sRankMap.put(Tweaks.class.getName(), RANK_AICP_TWEAKS);
