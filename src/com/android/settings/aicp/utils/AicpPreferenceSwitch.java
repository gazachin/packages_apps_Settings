...
public class AicpPreferenceSwitch extends Preference implements OnCheckedChangeListener {

    private static final String TAG = "AicpPreferenceSwitch";

    private Switch mSwitch;
    private String mSetting = null;
    private int mDefault = 0;

    public AicpPreferenceSwitch(Context context) {
        super(context);
    }

    public AicpPreferenceSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AicpPreferenceSwitch(Context context, AttributeSet attrs, int defStyle) {
